...
SECRET_KEY = 'django-insecure-g&9tlii-w3tv8p%lw!3*fh$zi*2o40!maoeq^3jcqordzp!z5h'
...
CORS_ALLOW_ALL_ORIGINS = True  # For localhost testing (later restrict)
...
AUTH_USER_MODEL = 'learnapp.CustomUser'
